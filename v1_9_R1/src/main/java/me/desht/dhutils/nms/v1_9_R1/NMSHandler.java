package me.desht.dhutils.nms.v1_9_R1;
...
public class NMSHandler implements NMSAbstraction {
	...
	public Vector[] getBlockHitbox(org.bukkit.block.Block block) {
		...
		AxisAlignedBB aabb = b.getBlock().a((IBlockData) null, (IBlockAccess) null, (BlockPosition) null);
		return new Vector[] {
				new Vector(block.getX() + aabb.a, block.getY() + aabb.b, block.getZ() + aabb.c),
				new Vector(block.getX() + aabb.d, block.getY() + aabb.e, block.getZ() + aabb.f)
		};
	}
